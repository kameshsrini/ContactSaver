...
public final class ContactController implements ActionListener,
	...
	public void actionPerformed(ActionEvent event) {
		...
		{	
			/* check if Valid InputFields and Present and FirstName, LastName and MiddleName of a person doesn't exist to perform modify*/
	...
	private void performDelete() {
		...
		if (contact == null)
		{
			mUI.showStatus("select contact to delete", false);
